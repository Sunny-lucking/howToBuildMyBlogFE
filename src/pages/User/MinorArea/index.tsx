            ...
            <div className="minor-area">
                <div className="sticky-wrap sticky">
                    <div className="stat-block block shadow">
                        ...
                        <div className="block-body">
                            <div className="stat-item">
                                ...
                                <span className="count">1,583</span>
                                </span>
                            </div>
                            <div className="stat-item">
                                ...
                                <span className="content">文章被阅读
                                     <span className="count">80,664</span>
                                </span>
                            </div>
                            {/* <div className="stat-item">
                    ...
                    <div className="follow-block block shadow">
                        <a href="/user/1204720476893064/following" className="follow-item">
                            <div className="item-title">关注了</div>
                            <div className="item-count">{props.authorInfo?.followers?.length}</div></a><a href="/user/1204720476893064/followers" className="follow-item">
                            <div className="item-title">关注者</div>
                            <div className="item-count">{props.authorInfo?.fans?.length}</div>
                        </a>
                    </div>
                    <div className="more-block block">
                        <a href="/user/1204720476893064/collections" className="more-item"><div className="item-title">收藏集</div><div className="item-count">3</div>
                        </a>
                        ...
                        <div className="more-item">
                            ...
                            <div className="item-count">
                                <time dateTime="2019-12-03T16:15:43.000Z" title="2019-12-04 00:15:43" className="time">2019-12-04</time>
                            </div>
                        </div>
                    </div>
                </div>

import {
    IMAGE_UPLOAD_URL,ARTICLE_ADD_URL,ARTICLE_LIST_URL,ARTICLE_DETAIL_URL,ARTICLE_CANCEL_PRAISE_URL,ARTICLE_PRAISE_URL,ARTICLE_FAVORITE_URL,ARTICLE_CANCEL_FAVORITE_URL,ARTICLE_DELETE_URL
